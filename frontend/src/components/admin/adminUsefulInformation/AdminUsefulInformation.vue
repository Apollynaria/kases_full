            ...
            <div class="p-0 w-100 content" style="background: #fff;">
                <div class="catalog-menu-headings position-relative mt-2">
                    <span class="p-3">
                        ...
                        &nbsp;Страница: {{ this.information.name }}&nbsp;
                        <router-link to="/adminListUsefulInformation" class="btn btn-secondary">ВЕРНУТЬСЯ К СПИСКУ СТРАНИЦ С
                    ...
                    <div class="p-3">
                            ...
                            <div class="" style="font-size: 12pt;">
                                <input class="form-check-input" type="checkbox" value="" v-model="checkOneInformation">
                                &nbsp;Отображать на сайте
                            </div>
                            ...
                            <div v-if="information.files.length <= 0 && information.files == null" class="mt-2">
                            ...
                            <div v-else class="row justify-content-center">
                                <div class="p-2 col-sm-12 col-md-6 col-lg-4 col-xl-4 col-xxl-2 col-12 p-3"
                                    v-for="(file, index) in information.files" :key="index">
                            ...
                            <div class="d-flex justify-content-between">
                                <input v-on:click="updateInformation()" class="btn btn-primary mt-3" value="      ИЗМЕНИТЬ      ">
                                <input class="btn btn-danger mt-3" value="УДАЛИТЬ" v-on:click="deleteInformation()">
                            </div>
                        </form>
                    </div>
                </div>
...
export default {
    ...
    methods: {
        ...
        getInformation() {
            http
                .get("/adminInformation/" + this.id)
                .then(response => {
                    this.information = response.data;
                    this.checkOneInformation = Boolean(this.information.isShow);
                })
                .catch(e => {
                    console.log(e);
                });
        ...
        updateInformation() {
            if (this.checkOneInformation === true) {
            ...
            http
                .post("/updateInformation/" + this.id, formData, {
                    headers: {
                        'Content-Type': 'multipart/form-data'
                    }
                })
                .then(() => {
                    this.$router.push('/adminListUsefulInformation')
                })
                .catch(e => {
                    this.$router.push('/adminListUsefulInformation')
                    console.log(e);
        ...
        deleteInformation() {
            http
                .post("/deleteInformation/" + this.id)
                .then(() => {
                    this.$router.push('/adminListUsefulInformation')
                })
                .catch(e => {
