            ...
            <div class="p-0 w-100 content" style="background: #fff;">
                <div class="catalog-menu-headings position-relative mt-2">
                    <span class="p-3">
                        ...
                        &nbsp;Список вакансий
                        <router-link to="/addVacancy" class="btn btn-secondary txt"><i class="bi bi-plus-lg"></i></router-link>
                    </span>
                    <br>
                    <div>
                        <ul class="list-group p-3">
                            <li class="list-group-item d-flex flex-row justify-content-between" v-for="(vacancy, index) in vacancies" :key="index">
                                <div class="">
...
export default {
    ...
    methods: {
        getVacancies() {
            http
                .get("/listVacancies/page=" + this.page)
                .then(response => {
