            ...
            <div class="p-0 w-100 content" style="background: #fff;">
                <div class="catalog-menu-headings position-relative mt-2">
                    <span class="p-3">
                        ...
                        &nbsp;Список новостей
                        <router-link to="/addNews" class="btn btn-secondary txt"><i class="bi bi-plus-lg"></i></router-link>
                    </span>
                    <br>
                    <div>
                        <ul class="list-group p-3">
                            <li class="list-group-item d-flex flex-row justify-content-between"
                                v-for="(news, index) in news_array" :key="index">
                                <div class="">
...
export default {
    ...
    methods: {
        getNews() {
            http
                .get("/listNews/page=" + this.page)
                .then(response => {
                    this.countPage = response.data.totalPages;
                    this.news_array = response.data.content;
