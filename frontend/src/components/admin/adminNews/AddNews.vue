            ...
            <div class="p-0 w-100 content" style="background: #fff;">
                <div class="catalog-menu-headings position-relative mt-2">
                    <span class="p-3">
                        ...
                        &nbsp;Добавление новости&nbsp;
                        <router-link to="/adminListNews" class="btn btn-secondary txt">ВЕРНУТЬСЯ К СПИСКУ
                    ...
                    <div class="p-3" v-if="!submitted">
                        <form @submit="addNews">
                            <div class="" style="font-size: 12pt;">
                                <input class="form-check-input" type="checkbox" value="" v-model="checkNews">
                                &nbsp;Отображать на сайте
                            </div>
                    ...
                    <div class="p-3" v-else>
                        ...
                        <button v-on:click="newNews()" class="btn btn-success mt-2" value="ДОБАВИТЬ">ДОБАВИТЬ НОВОСТЬ</button>
                    </div>
                </div>
            </div>
        </div>
